...
(lib.leaderboardquickatasteoffive = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(30).to({x:-136.1,alpha:1},0).to({x:147.5},10).to({x:127.5},6).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(40).to({x:-207.3,alpha:1},0).to({x:135.8},10,cjs.Ease.get(1)).to({x:115.8},6,cjs.Ease.get(1)).wait(33));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1507585391446", id:"index_atlas_"}
	],
	preloads: []
};
